...
**IMPORTANT**: Use the documentation index in `.cursor/rules/documentation-index.mdc` to decide which docs to create/update in each phase. Review existing design/plan/implementation docs before starting work, and update learnings and the index when patterns/structure change.
