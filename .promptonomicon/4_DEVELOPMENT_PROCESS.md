...
**IMPORTANT**: All implementation work MUST follow the Red-Green-Refactor pattern as defined in `.cursor/rules/red-green-refactor.mdc`:
1. Add/modify tests to go red.
...
**AI must obey the dependency management rules in `.cursor/rules/dependency-management.mdc`.**
...
4. Document why the dependency is needed in the appropriate Promptonomicon phase write-ups
5. Do NOT hand-edit lockfiles - allow them to be regenerated by the user
